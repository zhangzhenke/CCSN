...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser('CellFinder Training for image segmentation', add_help=False)
     # 批量大小
    ...
    parser.add_argument('--finetune', default='/home/share/huadjyin/home/zhangzhenke/Code/models/temp/MAEPretrain/checkpoint-30.pth',
    ...
    parser.add_argument('--data_path', default='./data', type=str,
                        help='dataset path')
    # 结果
    parser.add_argument('--output_dir', default='./temp/00/',
                        help='path where to save, empty for no saving')
    # 日志
    parser.add_argument('--log_dir', default='./temp/00/',
...
def main(args):
    ...
    dataset_train = DatasetTrain(cityscapes_data_path="./data/PublicCellBinData/", 
                                 cityscapes_meta_path="./data/PublicCellBinData/")
    print(dataset_train)

...
class DatasetTrain(torch.utils.data.Dataset):
    def __init__(self, cityscapes_data_path, cityscapes_meta_path):
        self.img_dir = cityscapes_data_path + "images/train/"
        self.label_dir = cityscapes_meta_path + "annotations/train/"
...
class DatasetVal(torch.utils.data.Dataset):
    def __init__(self, cityscapes_data_path, cityscapes_meta_path):
        self.img_dir = cityscapes_data_path + "images/test/"
        self.label_dir = cityscapes_meta_path + "annotations/test/"

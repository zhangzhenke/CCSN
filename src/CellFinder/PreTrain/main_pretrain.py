...
def get_args_parser():
    ...
    # Dataset parameters
    # 数据目录
    parser.add_argument('--data_path', default='/home/share/huadjyin/home/zhangzhenke/Code/models/pre_data/', type=str,
                        help='dataset path')
    # 输出目录
...
def main(args):
    ...
    pretrained_weights = torch.load('/home/share/huadjyin/home/zhangzhenke/Code/models/mae_visualize_vit_large.pth', map_location='cpu')
    ...
    output_path = os.path.join(args.output_dir, 'mae.png')
